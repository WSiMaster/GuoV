...
func (bcs *BlockchainServer) Address(w http.ResponseWriter, req *http.Request) {
	switch req.Method {
	case http.MethodGet:
		add := bcs.GetBlockchain().Address()
		ar := &block.AddressResponse{Address: add}
		m, _ := ar.MarshalJSON()
...
func (bcs *BlockchainServer) Run() {
	...
	http.HandleFunc("/address", bcs.Address)
